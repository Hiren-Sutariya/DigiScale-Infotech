...
export default function TechStack() {
  ...
  return (
    <section id="tech" className="py-14 lg:py-16 bg-accent/20">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        ...
        <div className="flex flex-col items-center w-full">
          <div className="flex flex-wrap justify-center gap-1 sm:gap-2 mb-8 p-1 sm:p-1.5 bg-white border border-border/50 rounded-xl shadow-sm max-w-full">
